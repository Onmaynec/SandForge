...
SandForge `0.2.0-alpha` is a .NET 8 CLI manager for Windows Sandbox sessions. It provides safe templates, SHA-256 verification, SQLite history, installer before/after collectors, crash recovery, cleanup commands and offline HTML/JSON reports.
